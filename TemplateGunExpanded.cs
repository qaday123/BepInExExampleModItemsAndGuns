...
namespace Mod
{
    public class TemplateGunExpanded : AdvancedGunBehavior
    {
        ...
        public static void Add()
        {
            ...
            /* OR */
            gun.gunSwitchGroup = $"{Plugin.MODPREFIX}_{FULLNAME.ToID()}"; //Unique name for your gun's sound group. In this example it uses your console name but with an underscore.
            ...
            /* OR */
            gun.DefaultModule.customAmmoType = CustomClipAmmoTypeToolbox.AddCustomAmmoType("Template Gun Orbs", "Mod/Resources/CustomGunAmmoTypes/tempgun_clipfull", "Mod/Resources/CustomGunAmmoTypes/tempgun_clipempty");
            ...
            gun.shellCasing = BreakableAPIToolbox.GenerateDebrisObject("Mod/Resources/CustomDebris/tempgun_shell").gameObject; //Example using a custom sprite as a casing (make sure the file path exists though).
